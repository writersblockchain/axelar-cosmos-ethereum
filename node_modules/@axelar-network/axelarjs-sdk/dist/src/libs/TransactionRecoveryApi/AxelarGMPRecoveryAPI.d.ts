...
export declare class AxelarGMPRecoveryAPI extends AxelarRecoveryApi {
     ...
     */
    calculateNativeGasFee(txHash: string, sourceChain: EvmChain, destinationChain: EvmChain, gasTokenSymbol: GasToken | string, options: QueryGasFeeOptions): Promise<string>;
    /**
    ...
    private getSigner;
    getGasReceiverContractAddress(chainName: EvmChain): Promise<string>;
}
